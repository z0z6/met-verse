...
export function buildRoom(scene) {
  ...
  ROOMS.forEach((room, i) => {
    ...
    // Ta sama liczba świateł na Androidzie i na komputerze (wcześniejsza
    // wersja oświetlenia, sprzed ograniczenia do 1 światła na mobile).
    const fillOffsets = [-DEPTH / 3.2, DEPTH / 3.2];
